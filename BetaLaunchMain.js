...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const mainHeaderShareButton = document.getElementById('main-header-share-button');
    const mainHeaderScoreboardRightHalf = document.getElementById('main-header-scoreboard-right-half');
    const mainHeaderScoreboard = document.getElementById("main-header-scoreboard");
    const mainHeaderBottomHalf = document.getElementById("main-header-inner-inner-bottom-half");
    const mainHeaderRightHalf = document.getElementById("main-header-right-half");

    function checkScreenSize() {
        if (window.matchMedia('(max-width: 900px)').matches) {
            // Move button-share to main-header-buttons
            if (!document.body.classList.contains('move-button-share')) {
                document.body.classList.add('move-button-share');
                mainHeaderShareButton.appendChild(buttonShare);
            }
        } else {
            // Move button-share back to main-header-scoreboard-right-half
            if (document.body.classList.contains('move-button-share')) {
                document.body.classList.remove('move-button-share');
                mainHeaderScoreboardRightHalf.appendChild(buttonShare);
            }
        }
        if (window.matchMedia('(max-width: 750px)').matches) {
            // Move button-share to main-header-buttons
            if (!document.body.classList.contains('move-scoreboard')) {
                document.body.classList.add('move-scoreboard');
                mainHeaderBottomHalf.appendChild(mainHeaderScoreboard);
            }
            if (document.body.classList.contains('move-button-share')) {
                document.body.classList.remove('move-button-share');
                mainHeaderScoreboardRightHalf.appendChild(buttonShare);
            ...
            // Move button-share back to main-header-scoreboard-right-half
            if (document.body.classList.contains('move-scoreboard')) {
                document.body.classList.remove('move-scoreboard');
                mainHeaderRightHalf.appendChild(mainHeaderScoreboard);
            }
        }
    }
